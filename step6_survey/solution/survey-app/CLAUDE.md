...
> 細則見同資料夾 `CODE-RULES-ui-本專案.md`；視覺規範見同資料夾 `design-system-summary.md`。
...
- token 實檔在工作坊 `step2_speedrun_kit/2.2_design_system/tokens/`（重點摘要見同資料夾 `design-system-summary.md`）；主色品牌紅 `#C8232C`。
