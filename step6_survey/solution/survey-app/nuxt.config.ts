...
export default defineNuxtConfig({
  ...
  app: {
    // GitHub Pages 子路徑部署（NFR-5）：專案頁網址是 https://<帳號>.github.io/<repo>/，
    // 所有靜態資源與路由都要加上這段前綴，否則整站 404。
    // 本機開發不設環境變數 → 預設 '/'；發布時用 pnpm generate:gh 帶入 .env.gh-pages 的 NUXT_APP_BASE_URL。
